...
The confusion matrix can be seen in Table \@ref(tab:lasso-confusion-matrix) and the performance metrics for the LASSO regression can be seen in Table \@ref(tab:lasso-evaluation). The LASSO model has a misclassification rate of 0.262, which is higher than the logistic regression but slightly lower than the boosted. The LASSO has a higher false positive rate when compared to the ridge regression at 0.155 and it has the lowest false negative rate of all the regression models at 0.436.
...
The confusion matrix can be seen in Table \@ref(tab:elnet-confusion-matrix) and the performance metrics for the elastic net regression can be seen in Table \@ref(tab:elnet-evaluation). The elastic net model has a misclassification rate of 0.297, which is the highest of all the regression models. The elastic net regression has the lowest false positive rate out of all the models at 0.070 and it has the highest false negative rate of all the models at 0.667.
